    ...
    <div className="min-h-full space-y-6 pb-8">
      ...
      <div
        className="
          ...
          bg-gradient-to-br from-[#eef8ef] via-[#e9f5ea] to-[#dcefe0]
          px-7 py-7 sm:px-10 sm:py-8
        "
      >
        <div className="relative z-10 max-w-xl">
          ...
          <p className="mt-3 text-sm leading-6 text-[#4d6152]">
            From your fields to the market — AyurHerb supports your
          ...
          <button
            ...
            className="
              ...
              bg-gradient-to-r from-[#1f6b3a] to-[#2c8a48]
              px-5 py-2.5 text-sm font-semibold text-white
              shadow-[0_10px_25px_rgba(31,107,58,0.25)]
              transition hover:shadow-[0_14px_30px_rgba(31,107,58,0.32)]
            "
          >
            Explore your farm
            <ArrowRight size={15} />
        ...
        <div
          className="
            ...
            hidden h-[220px] w-[220px] rounded-full
            bg-gradient-to-br from-[#bfe0c6] to-[#8fc79b]
            opacity-60 blur-2xl
            sm:block
          "
        />
        ...
        <Sprout
          ...
          className="
            ...
            hidden text-[#4d8957]/25 sm:block
          "
        />
      </div>
        ...
        {staticStats.map((stat) => (
          <div
            ...
            className="
              ...
              px-5 py-4 shadow-[0_10px_30px_rgba(31,69,39,0.05)]
            "
          >
            ...
            <p className="mt-0.5 text-xl font-semibold text-[#193522]">
              {stat.value}
            </p>
          </div>
        ))}

        {/* FARM WEATHER — clickable, toggles the panel below */}
        <button
          type="button"
          onClick={() => setShowWeather((value) => !value)}
          className="
            rounded-2xl border border-white/70 bg-white/90
            px-5 py-4 text-left shadow-[0_10px_30px_rgba(31,69,39,0.05)]
            transition hover:border-[#cfe3d1]
          "
        >
      ...
      {showWeather && (
        <div
          className="
            rounded-2xl border border-white/70 bg-white/90
            p-5 shadow-[0_10px_30px_rgba(31,69,39,0.05)]
          "
        >
          {farmLocation ? (
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-semibold text-[#28733d] hover:text-[#175f2c]"
            >
              View all
            </button>
          </div>
