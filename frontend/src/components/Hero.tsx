    ...
    <section className="relative">
      ...
      <div className="relative max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full text-base font-medium transition shadow-md"
        >
          Register as Farmer
        </button>
          ...
          className="border border-green-600 text-green-700 px-6 py-3 rounded-full text-base font-medium hover:bg-green-50 transition"
        >
          Join as Company
        </button>
          </div>
